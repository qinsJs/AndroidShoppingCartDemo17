...
public class Test1Adapter extends CartAdapter {
    private Context mContext;

    public Test1Adapter(Context context, ICart cart) {
        super(cart);
        mContext = context;
    }

    @Override
    protected View getItemView(int position, View convertView, ViewGroup parent, ShopBean b, ICart cart) {
        ViewHolder holder;
        if (convertView == null) {
